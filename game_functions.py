...
def fire_bullet(ai_settings,screen,ship,bullets):
    """Fires a bulet if limit is not reached yet"""
...
def update_bullets(ai_settings,screen,stats,sb,ship,aliens,bullets):
    ...
    # Get rid of bullets and get ris of old bullets
...
def create_alien(ai_settings,screen,aliens,alien_number,row_number):
    """Create a alien and pplace it in a row."""
...
def Create_fleet(ai_settings,screen,ship,aliens):
    ...
    # Create an alien and find numbers of alien in a row.
    alien = Alien(ai_settings,screen)
...
def update_aliens(ai_settings,screen,stats,sb,ship,aliens,bullets):
    ...
    Check if the fleet is at the edge,
      and then update the position of all the alien in the fleet
      """
